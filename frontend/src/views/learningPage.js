...
const viewBox_dict = {
    occupation: "0 0 128 128",
    communication: "0 0 128 128",
    commonsense: "0 0 128 128",
    tools: "0 0 128 128",
    ethic: "0 0 128 128",
};
        ...
        <>
            {!recommend ? (
                ...
                <div className="learning_page_recommendation">
                    <div className="learning_page_recommendation_ele">
                        <IconStructure
                            data={icon_dict[recommend]}
                            color={color_dict[recommend]}
                            size="5em"
                            index={0}
                            radius={0}
                            viewBox={viewBox_dict[recommend]}
                            x={0}
                            y={0}
                        />
                    </div>
        ...
        const fetchRecommendation = async () => {
            try {
                const response = await fetch(
                    `${process.env.REACT_APP_API_URL}/learn/recommendation/`,
                    {
